...
- `godot --headless --path . --script res://tests/test_presentation_quality.gd`: title handoff, camera impulse, enemy pose, Evolution overlay, reduced-effects and synthesized-audio checks.
