...
Current integrated evidence: 232 focused Godot assertions across relay, arena, simulation, chapter, optional repair, shop, variety, roaming quality and UI suites; 12/12 full-chapter normal-economy policies across the three representative seeds; natural policy captures at 1280x800 in `artifacts/core-quality`. Godot is pinned to 4.5.1. This is not human enjoyment evidence.
