...
**Status:** Expansion A, all ten base-weapon catalyst Evolutions, and the first three Gifts are enabled through P15; Confluences and all other entries remain design proposals.
**Current runtime:** preview 0.3.0 with ten automatic weapons, eight catalysts, ten Evolutions, three Gifts, four Blessings, four active slots, one reserve slot, and two Gift slots.
