...
func draw_results():
	...
	if not won:
		...
		text_at("PRIMARY CAUSE  " + summary.get("failure_cause", "UNCLASSIFIED") + " · largest loss " + loss_segment, Vector2(220, 498), 14, RED)
	...
	wrapped(memory_copy, Vector2(220, 590), 820, 14, MUTED)
